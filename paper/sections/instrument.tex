...
independent raters is in progress. Raters are native English readers with
professional editing experience, recruited on a freelance platform without
knowledge of the hypotheses or conditions, given a one-page guide with the
...
paid a fixed fee for about 90 minutes of work (\todo{US\$XX}). We will report
inter-rater agreement (Krippendorff's $\alpha$, pairwise Spearman) and
human--judge Spearman correlation per dimension. \todo{fill in when the
ratings arrive}
