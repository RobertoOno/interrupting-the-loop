...
matches the full scaffold on surprise and beats it on connection; injecting
the premise or the stream's own past is as bad as not interrupting; salience
events are good moments to look at and a poor clock. \todo{one sentence on
battery 3 (boundary, content, context) and the confirmatory replication}
The ordering replicates on three base models from two families, under a
