...
surprise 0.33, connection 0.17, coherence 2.08 (60 windows). The full scaffold
brings the stream to 3.22 / 1.60 / 3.72 (Cliff's $\delta=+0.88$ vs bare on
surprise, $p\approx10^{-16}$; every seed moves in the same direction,
...
preserved context---ties the full scaffold on surprise (3.08 vs 3.22, CI
\ci{-0.50}{+0.80}) and beats it on connection (3.15 vs 1.60, $\delta=-0.60$
for the scaffold, $p\approx3\times10^{-8}$) and coherence (4.78 vs 3.72), with
12/60 windows judged both surprising and coherent against 8/50 for the
scaffold and 0/60 for bare. Salience-only (review windows marked but nothing
injected) reaches 2.74. In sentence-embedding space
