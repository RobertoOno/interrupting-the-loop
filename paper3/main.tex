...
locating the residual gap in the proposer, with a pre-registered
operator-scoping follow-up (do the operators still pay at frontier
...
lacks --- which is precisely why the pre-registered operator-scoping runs
ask what the operators still buy \emph{at} frontier strength.
