...
def main() -> None:
    ...
    # Q6 — third generator family (OLMo-2-13B, a different pretraining diet)
    if FAMOLMO:
        EV = ("jump", "crystallize", "recurrence", "cut", "clock")
        q6 = [("bare", None, "OLMo: bare"),
              ("bare_habit", None, "OLMo: bare + habituation"),
              ("bare_reseed", ("cut", "clock"), "OLMo: bare + habituation + clock reseed 150"),
              ("scaffold0", EV, "OLMo: DREAM scaffold (λ=0)")]
        compare_table("Q6 — third generator family (OLMo-2-13B, 10 seeds)", q6, ref=1, pool=FAMOLMO)
        violin_fig("fig8_q6_familyolmo.png", q6, "Q6 — the ladder on a third generator family (OLMo-2-13B): bare → habituation → interruption → scaffold", pool=FAMOLMO)
